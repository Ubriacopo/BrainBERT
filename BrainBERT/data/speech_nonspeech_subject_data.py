...
class NonLinguisticSubjectData():
    ...
    def get_subj_data(self, subject):
        ...
        for trial in self.cfg.brain_runs:
            ...
            seeg_trial_no_word_data, labels = reader.get_aligned_non_words_matrix(duration=duration,
...
class SentenceOnsetSubjectData():
    ...
    def get_subj_data(self, subject):
        ...
        for trial in self.cfg.brain_runs:
            ...
            interval_duration = self.cfg.interval_duration
            seeg_trial_no_word_data, labels = reader.get_aligned_speech_onset_matrix(duration=duration,
                                                                                     interval_duration=interval_duration)
            labels['movie_id'] = t.movie_id
            trials.append(t)
            words.append(labels)
